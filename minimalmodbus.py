...
class Instrument():
    ...
    def __init__(self, port, slaveaddress,baudrate,timeout):
        self.serial = serial.Serial(baudrate=baudrate, port=port, parity=PARITY, bytesize=BYTESIZE, stopbits=STOPBITS, timeout=timeout)
        #self.serial.open()
        mode = 'rtu'
